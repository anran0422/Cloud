package com.anran.cloudlibrary.manager.auth;
...
import com.anran.cloudlibrary.manager.auth.model.SpaceUserPermissionConstant;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    private SpaceUserAuthContext getAuthContextByRequest() {
        ...
        if (ContentType.JSON.getValue().equals(contentType)) {
            ...
            authRequest = JSONUtil.toBean(body, SpaceUserAuthContext.class); // 转化为对象
        } else {
            Map<String, String> paramMap = ServletUtil.getParamMap(request);
            authRequest = BeanUtil.toBean(paramMap, SpaceUserAuthContext.class); // 转化为对象
        }
        // 根据请求路径区分 id 字段的含义
